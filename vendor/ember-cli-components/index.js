...
EmberCLIEmberComponentsAjax.prototype.included = function included(app) {
  ...
  if (options.enabled) {
    this.app.import('node_modules/ember-components/bower_components/ic-styled/main.js');
    this.app.import('node_modules/ember-components/bower_components/ember-utils/dist/globals/main.js');
    this.app.import('node_modules/ember-components//dist/globals/main.js');
  }
};
